...
<CommitGraph
  ...
  scenes={[
    ...
    },
    {
      ...
      rows: [
        { changeId: "ovvvnnor", desc: "Add a licence note", commitId: "5e6ce646", kind: "at", note: "LICENSE stayed; the change was rebased for you" },
...
<CommitGraph
  ...
  scenes={[
    ...
    },
    {
      ...
      rows: [
        { changeId: "ovvvnnor", desc: "Add a licence note", kind: "commit", note: "Rebased 2 descendant commits" },
        { changeId: "oklvxylu", desc: "Greet the world", kind: "commit" },
...
<CommitGraph
  ...
  hint="Watch @ stay where it is through the fetch, and move only on the rebase."
  scenes={[
    {
