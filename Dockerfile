...
ARG GITHUB_BRANCH=main
ARG GITHUB_CONTENT_PATH=content
ENV AWS_LWA_INVOKE_MODE=response_stream HOSTNAME=0.0.0.0 PORT=3000 CONTENT_SOURCE=${CONTENT_SOURCE} GITHUB_OWNER=${GITHUB_OWNER} GITHUB_REPO=${GITHUB_REPO} GITHUB_BRANCH=${GITHUB_BRANCH} GITHUB_CONTENT_PATH=${GITHUB_CONTENT_PATH}
