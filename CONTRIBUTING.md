...
Help us keep Blog open and inclusive.  
...
1. Search [Pull requests][Blog-pr] for an open or closed PR that relates to your submission.  You don't want to duplicate existing efforts.
