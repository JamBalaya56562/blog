 ...
 *
 * For any date-descending sorted post list and any slug in that list,
 * findAdjacentPosts should return:
 *   - previous (older post) = post at index + 1 (or null if last)
 *   - next (newer post) = post at index - 1 (or null if first)
 */
describe("Feature: post-navigation, Property 1: 前後記事の正確な特定", () => {
  /**
