 ...
 */
describe("Feature: post-navigation, Property 2: 条件付きリンク表示", () => {
 ...
 */
describe("Feature: post-navigation, Property 3: リンクhrefの正確性", () => {
 ...
 */
describe("Feature: post-navigation, Property 4: ラベルテキストの辞書一致", () => {
